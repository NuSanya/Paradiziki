...
/obj/item/clothing/suit/armor/reflector
	...
	ru_names = list(
		NOMINATIVE = "светоотражающее пальто",
		GENITIVE = "светоотражающего пальто",
		DATIVE = "светоотражающему пальто",
		ACCUSATIVE = "светоотражающее пальто",
		INSTRUMENTAL = "светоотражающим пальто",
		PREPOSITIONAL = "светоотражающем пальто"
	)
