...
/proc/debug_variable(name, value, level, datum/DA = null, sanitize = TRUE, display_flags)
	...
	if(isnull(value))
		...
		#ifdef VARSICON
		item = "[name] = /icon (<span class='value'>[value]</span>) [icon2base64html(value)]"
		#else
		...
		var/image/I = value
		#ifdef VARSICON
		item = "<a href='byond://?_src_=vars;Vars=[I.UID()]'>[name] \ref[value]</a> = /image (<span class='value'>[value]</span>) [icon2base64html(value)]"
		#else
